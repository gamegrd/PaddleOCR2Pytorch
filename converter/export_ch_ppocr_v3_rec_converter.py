    ...
    def load_paddle_weights(self, paddle_weights):
        ...
        for k, v in self.net.state_dict().items():
            ...
            ppname = ppname.replace(
                'neck.encoder.', 'head.ctc_encoder.encoder.')
            ...
            try:
                ...
                print('paddle: {}, {}'.format(
                    ppname, para_state_dict[ppname].shape))
                raise e
...
if __name__ == '__main__':
    ...
    paddle_pretrained_model_path = os.path.join(
        os.path.abspath(args.src_model_path), 'best_accuracy')
    ...
    torch.onnx.export(converter.net,
                      inp,
                      'ch_ptocr_v3_rec_infer.onnx',
